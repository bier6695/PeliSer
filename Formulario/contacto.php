...
$destinatario = "comunidadtvo@gmail.com"; # aquí la persona que recibirá los mensajes
...
if ($resultado) {
    echo "<h3>¡Gracias por contactarme!</h3>";
    echo "<p>Tu mensaje se ha enviado correctamente.</p><h4>Importante</h4><p>Revisa tu bandeja de SPAM, en ocasiones mis respuestas quedan ahí. </p>";
} else {
